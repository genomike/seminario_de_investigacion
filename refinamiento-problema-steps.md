...
## Paso 3. Artículos encontrados (selección final — 18 artículos)

Se consolidó una muestra de 18 artículos recientes con DOI verificable, organizados según su aporte a las fases del modelo propuesto.
...
- **Tipo:** pre-experimental (pre-test / post-test con grupo único) o cuasi-experimental si se incluye grupo control.
...
- **Análisis:** prueba de diferencias pareadas (Wilcoxon o t-test según normalidad) para comparar indicadores antes y después de la implementación.
