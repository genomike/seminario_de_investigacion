...
La Tabla 14 detalla la especificación técnica de cada indicador, incluyendo su dimensión, fórmula de cálculo, unidad de medida y fuente de datos.
...
La Tabla 15 sintetiza las métricas de resultados reportadas en estudios internacionales de implementación FHIR que constituyen los referentes empíricos para los indicadores del presente estudio.
...
![Relación entre variable independiente y variable dependiente](media/diagrama-relacion-variables.png)
...
La Tabla 17 presenta una síntesis comparativa de los diseños metodológicos empleados en los estudios de referencia sobre interoperabilidad FHIR, situando la presente investigación en el contexto de la literatura.
...
: Tabla 7. Síntesis comparativa de diseños metodológicos en estudios de interoperabilidad FHIR
...
![Diseño pre-experimental pre-test / post-test con un solo grupo](media/diagrama-diseno-preexperimental.png)
...
Además de las técnicas de medición de variables, el enfoque mixto del estudio requiere técnicas cualitativas —detalladas en la Tabla 19— que contribuyen a los objetivos descriptivos (OE1, OE2) y propositivos (OE5), pero que no miden indicadores de la variable dependiente ni se utilizan para la contrastación de hipótesis:
...
La Tabla 20 detalla las pruebas estadísticas que se aplicarán a cada indicador, incluyendo su vinculación con las hipótesis específicas, el tipo de prueba, los supuestos requeridos y la herramienta de software a utilizar.
...
: Tabla 9. Pruebas estadísticas por indicador de calidad del intercambio clínico
...
**Fuente de financiamiento:** Autofinanciado por los investigadores.

La Tabla 22 presenta la distribución del presupuesto agrupada por fase de la investigación, lo que permite identificar el peso financiero de cada etapa del estudio.
...
![Diagrama de Gantt del cronograma de actividades de la investigación](media/diagrama-cronograma-gantt.png)
